...
export const config = {
  ...
  paper_trading: {
    ...
    max_open_positions: 1, // Maximum number of concurrent trading positions
    recent_trades_limit: 10, // Number of recent trades to display in dashboard
    price_check: {
      ...
      max_delay: 5000, // Maximum delay between price retries (ms) from dex
    }
  },
