...
> **Important**: Before starting, please carefully read and follow the setup instructions in [Instructions.md](Instructions.md). This guide contains essential information about configuration, environment variables, and running the bot.
...
Please refer to [Instructions.md](Instructions.md) for detailed setup and usage instructions.

### Prerequisites

- [Node.js](https://nodejs.org/en) installed on your computer
- Basic understanding of Solana blockchain and TypeScript
